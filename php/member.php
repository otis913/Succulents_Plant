					...
					<div class="center_contain">
						...
						<form id="validationForm" method="POST" action="./update.php">
							...
							<div class="mem_wrp ">
								...
								<input style="background-color:transparent" type="button" class="save keydown" value='' onclick="ChangeDisabled(2)">
							...
							<div class="mem_wrp ">
								...
								<input style="background-color:transparent" type="button" class="save keydown" value='' onclick="ChangeDisabledPhone(2)">
								<br />
							</div>
							<div class="mem_wrp">
								<label for="">地址： </label>
								...
								<input style="background-color:transparent" type="button" value='' onclick="ChangeDisabledAdd(2)">
							</div>
